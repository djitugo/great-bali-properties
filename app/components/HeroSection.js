...
export default function HeroSection() {
  return (
    <div style={{ position: 'relative', minHeight: '100vh', display: 'flex', alignItems: 'center' }}>
      ...
      {/* Content */}
      <div style={{ position: 'relative', zIndex: 2, padding: '120px 48px 80px', maxWidth: '1100px', margin: '0 auto', width: '100%' }}>
        ...
        <motion.p
          ...
          style={{ color: 'rgba(255,255,255,0.65)', fontSize: '17px', maxWidth: '460px', marginBottom: '36px', lineHeight: 1.65 }}>
