...
export const translations = {
  id: {
    ...
    'Elevating Bali Real Estate:': 'Meningkatkan Standar Properti Bali:',
    'Our Journey and Commitment': 'Perjalanan dan Komitmen Kami',
    'Our Story: Born from a Passion for Bali': 'Cerita Kami: Lahir dari Kecintaan pada Bali',
    'Great Bali Properties was founded on a singular, powerful conviction: buying property in Bali should be an inspiring and seamless journey, not a source of stress. Having witnessed many investors struggle with complex legalities, misleading listings, and lack of accountability, we set out to build something fundamentally different.': 'Great Bali Properties didirikan atas satu keyakinan kuat: membeli properti di Bali harus menjadi perjalanan yang menginspirasi dan mulus, bukan sumber stres. Menyaksikan banyak investor berjuang dengan legalitas yang rumit, listing yang menyesatkan, dan kurangnya akuntabilitas, kami memutuskan untuk membangun sesuatu yang benar-benar berbeda.',
    "We established a real estate agency rooted in transparency, profound local knowledge, and a genuine commitment to our clients' success. As a proud partner of Great Bali Villas — one of the island's most respected villa management companies — we bring over a decade of on-the-ground expertise to every transaction. Today, we serve a global community of buyers and investors, helping them navigate the Indonesian property market with absolute confidence — from the first inquiry to the final handover and beyond.": "Kami membangun agensi properti yang berlandaskan transparansi, pengetahuan lokal yang mendalam, dan komitmen tulus terhadap kesuksesan klien. Sebagai partner resmi Great Bali Villas — salah satu perusahaan manajemen villa paling terpercaya di pulau ini — kami membawa lebih dari satu dekade pengalaman lapangan ke setiap transaksi. Hari ini, kami melayani komunitas global pembeli dan investor, membantu mereka menavigasi pasar properti Indonesia dengan penuh keyakinan — dari pertanyaan pertama hingga serah terima akhir dan seterusnya.",
    'Years in Bali': 'Tahun di Bali',
    'Our Track Record': 'Rekam Jejak Kami',
    'Our Proven Track Record': 'Rekam Jejak Kami yang Terbukti',
    'in Numbers': 'dalam Angka',
    'At Great Bali Properties, our scale is your advantage. We combine extensive reach with localized precision to deliver exceptional results.': 'Di Great Bali Properties, skala kami adalah keunggulan Anda. Kami memadukan jangkauan luas dengan presisi lokal untuk memberikan hasil yang luar biasa.',
    'Years of Local Mastery': 'Tahun Keahlian Lokal',
    "A decade of navigating the evolving Bali landscape. We don't just know the market; we have lived through its cycles, giving us the foresight to identify high-yield opportunities before they go mainstream.": 'Satu dekade menavigasi lanskap Bali yang terus berkembang. Kami tidak sekadar mengenal pasar; kami telah melewati siklus-siklusnya, memberikan kami kemampuan untuk mengidentifikasi peluang imbal hasil tinggi sebelum menjadi arus utama.',
    'Properties Under Direct Management': 'Properti di Bawah Manajemen Langsung',
    "Our portfolio of managed assets is a testament to our owners' trust. By maintaining a focused selection, we ensure each property — from boutique cottages to luxury estates — receives the meticulous care and data-driven optimization needed to outperform the market.": 'Portofolio aset yang kami kelola adalah bukti kepercayaan para pemilik. Dengan mempertahankan seleksi yang terfokus, kami memastikan setiap properti — dari cottage butik hingga estate mewah — mendapatkan perawatan teliti dan optimasi berbasis data untuk melampaui pasar.',
    'Dedicated Professionals': 'Profesional Berdedikasi',
    'Your investment is backed by a powerhouse team of 30+ specialists. From legal experts and marketing strategists to on-the-ground property managers, we provide a 360-degree support system that ensures no detail is overlooked.': 'Investasi Anda didukung oleh tim tangguh 30+ spesialis. Dari pakar hukum dan ahli strategi pemasaran hingga manajer properti lapangan, kami menyediakan sistem dukungan 360 derajat yang memastikan tidak ada detail yang terlewatkan.',
    'End-to-End Excellence': 'Keunggulan Menyeluruh',
    'We bridge the gap between "buying a house" and "owning a successful business." By leveraging our management expertise, we ensure your property remains a high-performing asset with a hotel-standard guest experience.': 'Kami menjembatani kesenjangan antara "membeli rumah" dan "memiliki bisnis yang sukses." Dengan memanfaatkan keahlian manajemen kami, kami memastikan properti Anda tetap menjadi aset berdaya tinggi dengan pengalaman tamu berstandar hotel.',
    ...
    "With a rich background spanning property development and hospitality management across Southeast Asia, Mei Lin is the driving force behind Great Bali Properties' strategic growth. She excels at identifying emerging market trends, forging high-value partnerships, and expanding our portfolio of investment-ready properties. Her sharp instinct for opportunity and deep regional network make her an invaluable asset for investors seeking the next big move in Bali.": 'Dengan latar belakang kaya di bidang pengembangan properti dan manajemen perhotelan di Asia Tenggara, Mei Lin adalah kekuatan pendorong di balik pertumbuhan strategis Great Bali Properties. Ia unggul dalam mengidentifikasi tren pasar yang berkembang, membangun kemitraan bernilai tinggi, dan memperluas portofolio properti siap investasi kami. Insting tajamnya terhadap peluang dan jaringan regional yang luas menjadikannya aset tak ternilai bagi investor yang mencari langkah besar berikutnya di Bali.',
    'Intan brings rigorous financial discipline to every aspect of our operations. Specializing in P&L management, rental yield analysis, and Indonesian tax compliance, she ensures that every property in our portfolio is optimized for maximum profitability. Her detailed financial reporting and transparent investor communications give our clients complete confidence in the performance and integrity of their Bali investments.': 'Intan membawa disiplin keuangan yang ketat ke setiap aspek operasional kami. Dengan spesialisasi di manajemen P&L, analisis yield sewa, dan kepatuhan pajak Indonesia, ia memastikan setiap properti dalam portofolio kami dioptimalkan untuk profitabilitas maksimal. Pelaporan keuangan yang terperinci dan komunikasi investor yang transparan memberikan kepercayaan penuh kepada klien kami atas kinerja dan integritas investasi Bali mereka.',
    "Puspita is the expert guide who turns interest into investment. With a deep understanding of what drives ROI in Bali's competitive rental market, she assists clients in selecting properties with the strongest performance potential. She oversees seamless onboarding onto global rental platforms including Airbnb, Booking.com, and Agoda, ensuring every new property is positioned for immediate, high-occupancy success from day one.": 'Puspita adalah pemandu ahli yang mengubah ketertarikan menjadi investasi. Dengan pemahaman mendalam tentang apa yang mendorong ROI di pasar sewa Bali yang kompetitif, ia membantu klien dalam memilih properti dengan potensi kinerja terkuat. Ia mengawasi onboarding yang mulus ke platform rental global termasuk Airbnb, Booking.com, dan Agoda, memastikan setiap properti baru siap meraih kesuksesan tingkat hunian tinggi sejak hari pertama.',
